...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // No explicit RainbowGum.of() call needed at all: rainbowgum-helidon4's own
        // LoggingProvider bootstraps Rainbow Gum before this line even runs (see
        // README.md's rainbowgum-helidon4 finding).
