...
public sealed interface LogFormatter {
	...
	public enum NoopFormatter implements 
		InstantFormatter, ThrowableFormatter, KeyValuesFormatter, LevelFormatter, NameFormatter, ThreadFormatter {
		INSTANT;
