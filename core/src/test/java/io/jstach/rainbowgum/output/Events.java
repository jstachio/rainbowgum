 ...
 * rainbowgum-test-core's copy of the same class (originally FileOutputTest's own nested
 * enum, before FileOutputTest/LogFormatterTest moved there since core's own test-phase
 * time gates the whole reactor) - rainbowgum-core can't depend on a test module.
 */
enum Events {
