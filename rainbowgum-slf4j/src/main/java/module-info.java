 ...
 * <p>
 * The SLF4J API does not document nullability for {@link org.slf4j.spi.MDCAdapter} or
 * {@link org.slf4j.spi.LoggingEventBuilder#addArgument(Object)} (see
 * <a href="https://github.com/qos-ch/slf4j/issues/493">slf4j#493</a>). Rainbow Gum
 * accepts <code>null</code> more widely than SLF4J's own signatures require - e.g. MDC
 ...
 * <code>null</code> where SLF4J itself gives no guarantee it is supported.
 * <p>
 * Like SLF4J's own reference {@link org.slf4j.spi.LoggingEventBuilder} implementation,
