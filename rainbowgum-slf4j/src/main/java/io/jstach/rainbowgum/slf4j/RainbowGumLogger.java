...
class RainbowGumLogger extends LegacyAbstractLogger {
	...
	public RainbowGumLogger(String name, LogAppender appender, java.lang.System.Logger.Level level) {
		super();
	...
	protected void handleNormalizedLoggingCall(Level level, Marker marker, String messagePattern, Object[] arguments,
		...
		LogEvent logEvent = LogEvent.of(Levels.toSystemLevel(level), loggerName, formattedMessage, keyValues,
				throwable);
